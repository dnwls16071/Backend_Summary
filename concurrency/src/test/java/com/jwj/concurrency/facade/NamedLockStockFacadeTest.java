...
import com.jwj.concurrency.facade.namedlock.NamedLockStockFacade;
...
class NamedLockStockFacadeTest {
	...
	@Autowired private NamedLockStockFacade stockFacade;
	...
	@Test
	@DisplayName("동시에 여러 요청을 통한 상품 주문시 수량만큼의 재고 감소가 이루어진다.(네임드 락)")
	void 동시에_여러_요청을_통한_상품_주문시_수량만큼의_재고_감소가_이루어진다() throws InterruptedException {
		...
		/*
		 * 네임드 락을 사용하는 경우 -> 특정 이름의 락을 거는 것과 해제하는 로직을 직접 작성
	    */
